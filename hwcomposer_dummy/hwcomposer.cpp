...
static int hwc_get_display_attributes(hwc_composer_device_1* dev,
    ...
    while (*attributes != HWC_DISPLAY_NO_ATTRIBUTE) {
        ...
        case HWC_DISPLAY_VSYNC_PERIOD:
            *values = 1000*1000*1000/60; // vsync is 60 hz
            break;
        case HWC_DISPLAY_WIDTH:
            property_get("ro.vendor.display_width", property, "1080");
            *values = atoi(property);
            break;
        case HWC_DISPLAY_HEIGHT:
            property_get("ro.vendor.display_height", property, "1920");
            *values = atoi(property);
            break;
        case HWC_DISPLAY_DPI_X:
        case HWC_DISPLAY_DPI_Y:
            property_get("ro.sf.lcd_density", property, "320");
            *values = 1000 * atoi(property);
            break;
        default:
